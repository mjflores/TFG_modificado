...
def trackRegion(frame, bbox, x_pred, P_pred):
    ...
    #CAL CANVIAR EL DEBUGMODE PER A QUE ENTRI EL WIN
    centers, size = detectNN(frame, win)
    ...
    #Here I return the regions, that would be the detections, I need a z=(x1,y1,v1,v2)
    #HEY! The H*x = (1,2) means that z must not have velocity :/
